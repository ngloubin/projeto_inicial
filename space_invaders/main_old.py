...
pygame.display.set_caption("Space Invaders do Matheus N")
...
def main():
    ...
    while run:
        ...
        if lost:
            if lost_count > FPS * 2:  # Espera por 2 segundos
                run = False
            else:
                continue
        ...
        if lost and lost_count == FPS * 2:
            pygame.time.delay(2000)  # Aguarda 2 segundos antes de voltar ao menu
